...
import WebContainerPreview from "@/modules/webcontainers/conponents/webcontainer-preview";
    ...
    async (fileId?: string) => {
      ...
      try {
        ...
        if (instance && instance.fs) {
          console.log("Writing file to WebContainer:", filePath);
          console.log("File content:", fileToSave.content);
